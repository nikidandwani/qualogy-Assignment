 ...
 * offset, so that we can test code that depends on local timezone settings without tasklist on
 ...
 * sends the request to a real server using $httpBackend service. With tasklist injection, it is
